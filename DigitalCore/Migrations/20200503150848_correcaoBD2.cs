...
{
    public partial class correcaoBD2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ID", "Designacao", "TipoProdutoID" },
                values: new object[,]
                {
                    { 1, "Processador Intel i7 9700, 16GB RAM, Disco HDD 2TB, Grádica nVidia4GB, Windows10 Home", null },
                    { 20, "Português 106 Teclas USB", null },
                    { 18, "Intel i7 8700", null },
                    { 17, "2GB", null },
                    { 16, "AMD Radeon 520", null },
                    { 15, "1TB", null },
                    { 14, "8GB", null },
                    { 13, "2,40GHz", null },
                    { 12, "Intel i5", null },
                    { 11, "Intel i5 8250U", null },
                    { 19, "Intel i5 8250U", null },
                    { 9, "240", null },
                    { 8, "512", null },
                    { 7, "3GB", null },
                    { 6, "NVIDIA® GeForce® GTX 1060", null },
                    { 5, "HD 23pol. 1080x720", null },
                    { 4, "FULL HD 24pol. 1920x1080", null },
                    { 3, "Processador Intel i3 5700, 4GB RAM, Disco HDD 500GB, Grádica nVidia1GB, Windows10 Home", null },
                    { 2, "Processador Intel i5 7500, 8GB RAM, Disco HDD 1TB, Grádica nVidia2GB, Windows10 Home", null },
                    { 10, "120", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "2300-538", "pconceicao@yahoo.com", "Tomar", "Rua João Torres, Nº94", "115836783", "Pedro Conceição", "213", "249765638", "pconceicao" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 3, 1, 599.89999999999998 },
                    { 3, 3, 3, 698.89999999999998 },
                    { 2, 2, 3, 999.89999999999998 },
                    { 1, 1, 3, 1699.0 },
                    { 7, 6, 7, 89.0 },
                    { 5, 4, 2, 249.90000000000001 },
                    { 6, 5, 2, 199.90000000000001 }
                });
