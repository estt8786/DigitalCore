    ...
    public class DigitalCoreDB : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cliente>().HasData(
               ...
               new Cliente { ID = 2, Nome = "Pedro Conceição", Username = "pconceicao", Password = "213", Morada = "Rua João Torres, Nº94", CodPostal = "2300-538", Localidade = "Tomar", Email = "pconceicao@yahoo.com", Telefone = "249765638", NIF = "115836783" },
            ...
            modelBuilder.Entity<Produto>().HasData(
              new Produto { ID = 1, NumSerie = "123456789", CompraFK = 1, TipoProdutoFK = 1, Marca = "HP", Modelo = "Omen 880", Descricao = "HP Omen 880-106Np", Preco = 1200.00, IVA = 23 },
              new Produto { ID = 2, NumSerie = "123456790", CompraFK = 1, TipoProdutoFK = 5, Marca = "Toshiba", Modelo = "TR200", Descricao = "Toshiba TR200 3D TLC SATA III", Preco = 55.00, IVA = 23 },
              new Produto { ID = 3, NumSerie = "123456791", CompraFK = 2, TipoProdutoFK = 1, Marca = "Asus", Modelo = "ROG GR8II", Descricao = "Asus ROG GR8II-T022Z Auta", Preco = 950.00, IVA = 23 },
              new Produto { ID = 4, NumSerie = "123456792", CompraFK = 3, TipoProdutoFK = 1, Marca = "Asus", Modelo = "D320MT", Descricao = "Asus D320MT", Preco = 600.00, IVA = 23 },
              new Produto { ID = 5, NumSerie = "123456793", CompraFK = 4, TipoProdutoFK = 5, Marca = "Samsung", Modelo = "EVO 850", Descricao = "Samsung 500GB EVO 850", Preco = 125.00, IVA = 23 },
              new Produto { ID = 6, NumSerie = "123456794", CompraFK = 5, TipoProdutoFK = 5, Marca = "Kingston", Modelo = "A400", Descricao = "Kingston 120GB SSD A400 SATA III", Preco = 35.00, IVA = 23 },
              new Produto { ID = 7, NumSerie = "123456795", CompraFK = 5, TipoProdutoFK = 3, Marca = "HP", Modelo = "bs109np", Descricao = "HP 15-bs109np", Preco = 550.00, IVA = 23 },
              new Produto { ID = 8, NumSerie = "123456796", CompraFK = 5, TipoProdutoFK = 3, Marca = "Asus", Modelo = "UX430UA", Descricao = "Asus Zenbook UX430UA-78DHDCB1", Preco = 1200.00, IVA = 23 }
              );
